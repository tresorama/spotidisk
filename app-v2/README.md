...
Here you will find premilinary info, for deep dive see the following guides:

- [Backend](./backend-python/README.md#run-server-locally)
- [Frontend](./frontend-react/README.md#getting-started)
- Electron - missing docs (read this document)
- [Test-Unit](./backend-python/README.md#run-tests)
...
- [Launch Backend](./backend-python/README.md#run-server-locally)
- [Launch Frontend](./frontend-react/README.md#getting-started)

### Test

For tests, that we can run manually in cli, we use:

- [unit tests with pytest](./backend-python/README.md#run-tests)
- [e2e tests with playwright](./test-e2e/README.md)
